//document.getElementById('personagens').innerHTML = '40'
...
preencherContadores();
preencherTabela();      google.charts.load('current', {'packages':['corechart']});
...
async function desenharGrafico() {
    ...
    const dateArray = [];
    dateArray.push(["veículos", "passageiros"]);
    vehiclesArray.forEach( vehicle =>{

        dateArray.push([ vehicle.name, Number(vehicle.passengers)]);
